...
- `sofle_right-nice_nano-zmk.uf2`
- `sofle_left-nice_nano-zmk.uf2`
...
- If you are having trouble flashing, you can always flash the `settings_reset-nice_nano-zmk.uf2` file first. This is a good way to make sure 
...
file (i.e. the right side with the `sofle_right-nice_nano-zmk.uf2` file), you may find it helpful to follow the following order:
